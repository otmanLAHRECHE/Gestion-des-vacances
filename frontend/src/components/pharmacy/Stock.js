...
const columns = [
    ...
    { field: 'lot_number', headerName: 'N*lot', width: 150 },
    { field: 'medic_lot_price', headerName: 'Prix unit', width: 150 },
...
export default function Stock(){
    ...
    const [lotPriceError, setLotPriceError] = React.useState([false, ""]);
    ...
    const theme = useTheme
      ...
      const addStockSave = async () =>{
        ...
        if(arivage == null || arivage == ""){
          ...
          if(lotPrice == null || lotPrice == "" || lotPrice == "0"){
            test = false;
            setLotPriceError([true, "champ est obligatoire"]);
          }
      ...
      React.useEffect(() => {
        try{
          ...
          setLot(rowData.lot_number);
          setLotPrice(rowData.medic_lot_price);
            ...
            <Dialog open={open} onClose={addStockClose}  maxWidth="md" fullWidth={true}>
                          <DialogTitle>Ajouter un médicament au stock</DialogTitle>
                            ...
                            <TextField
                                ...
                                />
                                <TextField
                                  error={lotPriceError[0]}
                                  helperText={lotPriceError[1]}
                                  required
                                  disabled = {lotState}
                                  margin="dense"
                                  label="Prix unit de lot"
                                  fullWidth
                                  variant="standard"
                                  value = {lotPrice}
                                  onChange={(event) => {setLotPrice(event.target.value)}}
                                />
