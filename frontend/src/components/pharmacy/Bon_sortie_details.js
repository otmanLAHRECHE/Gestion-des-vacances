...
const Transition = React.forwardRef(function Transition(props, ref) {
  ...
  const columns = [
    ...
    { field: 'lot_number', headerName: 'N*lot', width: 140, valueGetter: (params) =>
    `${params.row.med_sortie.lot_number || ''}` },
    ...
    { field: 'medic_lot_price', headerName: 'Prix ut', width: 140, valueGetter: (params) =>
      `${params.row.med_sortie.medic_lot_price || ''}` },
